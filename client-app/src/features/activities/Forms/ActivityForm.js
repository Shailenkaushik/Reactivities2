  ...
  return (
    <Segment clearing>
     ...
     <Form onSubmit={handleSubmit}>
        ...
        <Form.Input placeholder='Date' onChange={handleInputChange} value={activity.entryDate} name='entryDate'/>
        ...
        <Button onClick={props.closeForm} floated='right'  type='button' content='Cancel' ></Button>
     </Form>
